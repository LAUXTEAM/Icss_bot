...
UPSTREAM_REPO = "https://github.com/LAUXTEAM/Icss_bot"
...
async def deploy(event, repo, ups_rem, ac_br, txt):
    if HEROKU_API_KEY is not None:
        ...
        if heroku_app is None:
            ...
            return repo.__del__()
        await event.edit(
            "**جاري تحديث || تنصيب السورس نسخه 2021   يتم تثبيت البيانات\n Updating || The installation of the source version 2021, the data is installed . Time 4/5 scend**"
        )
        ups_rem.fetch(ac_br)
